...
mod tests {
    ...
    fn basics() {
        ...
        parse_date_string("12am", base, Dialect::Uk).expect("should parse");
        parse_date_string("1pm", base, Dialect::Uk).expect("should parse");
        parse_date_string("12pm", base, Dialect::Uk).expect("should parse");
    }
